...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertStudent`(IN FirstName varchar(25), IN LastName varchar(25),
                                               IN StudentEmail varchar(25), IN AcademicYear varchar(25),
                                               IN Major varchar(25))
BEGIN
    declare spk int DEFAULT 0;
    ...
    IF spk=0 THEN
	    ...
	    VALUES (FirstName, LastName, StudentEmail, AcademicYear, Major);
    end if;
...
BEGIN
    ...
    FROM
         CareerFairCompanies
    INNER JOIN
        Companies c on CompanyID=c.pkCompany
    INNER JOIN
        CareerFairs cf on CareerFairID=cf.pkCareerFair;
...
-- Dump completed on 2020-04-12 15:37:53

...
INSERT INTO `Companies` VALUES (1,'Microsoft','badpassword123','example@microsoft.com'),(2,'Amazon','password12','example@amazon.com'),(3,'Bloomberg','okaypassword23','example@bloomberg.com'),(4,'Google','randompassword3','example@google.com'),(5,'Facebook','weirdpassword4','example@facebook.com'),(6,'AirBnb','password4235','example@airbnb.com');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `addInterviewToSchedule`(IN Company varchar(25), IN pEmail varchar(25),
                                                        IN pTime varchar(50), IN pPosition varchar(25),
                                                        IN pNotes varchar(10000), IN pSemester varchar(50),
                                                        IN pYear varchar(4))
BEGIN
	...
	INSERT INTO
		...
		CareerFairID, IsInterviewing)
	VALUES
		(sKey, cKey, pTime, pPosition, pNotes, cfKey, 1);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `associateStudentWithCompany`(IN StudentEmail varchar(25), IN Company varchar(25),
                                                             IN pSemester varchar(50), IN pYear varchar(4),
                                                             IN Interviewing bit)
BEGIN
	...
	IF sKey!=0 and cKey!=0 and cfKey!=0 THEN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertStudent`(IN pFirst varchar(25), IN pLast varchar(25),
                                               IN pEmail varchar(25), IN pAcademicYear varchar(25),
                                               IN pMajor varchar(25))
BEGIN
    declare spk int DEFAULT 0;
    ...
    IF spk=0 THEN
	    ...
	    VALUES (pFirst, pLast, pEmail, pAcademicYear, pMajor);
    end if;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `queryAdminInfo`(IN User varchar(50))
BEGIN
	SELECT
		FirstName,
	    LastName,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `queryAdminPassword` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `queryAdminPassword`(IN User varchar(50))
BEGIN
	SELECT
		Password
	FROM Admins
...
BEGIN
    ...
    SELECT
        ...
        cf.Year
    FROM
         CareerFairCompanies cfc
    INNER JOIN
        CareerFairs cf on cfc.CareerFairID = cf.pkCareerFair
    INNER JOIN
        Companies c on cfc.CompanyID = c.pkCompany;
...
BEGIN
    ...
    WHERE CompanyID=cKey and IsInterviewing=1;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `queryCompanyInterviewsAtACareerFair` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `queryCompanyInterviewsAtACareerFair`(IN Company varchar(25), pSemester varchar(15), pYear varchar(4))
BEGIN
	DECLARE cKey INT DEFAULT 0;
    ...
    INNER JOIN
	    CareerFairs cf on i.CareerFairID = cf.pkCareerFair
    WHERE CompanyID=cKey and IsInterviewing=1 and cf.Semester=pSemester and cf.Year=pYear;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `queryCompanyStudents` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `queryCompanyStudents`(IN Company varchar(25))
BEGIN
	DECLARE cKey INT DEFAULT 0;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `queryCompanyStudentsAtACareerFair` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `queryCompanyStudentsAtACareerFair`(IN Company varchar(25), pSemester varchar(15), pYear varchar(4))
BEGIN
	DECLARE cKey INT DEFAULT 0;
    ...
    INNER JOIN
	    CareerFairs cf on i.CareerFairID = cf.pkCareerFair
    WHERE CompanyID=cKey and cf.Semester=pSemester and cf.Year=pYear;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `queryStudentInfo`(IN pEmail varchar(25), IN Company varchar(25),
                                                  IN CareerFairSemester varchar(25), IN CareerFairYear varchar(25))
BEGIN
	DECLARE cKey INT DEFAULT 0;
	DECLARE cfKey INT DEFAULT 0;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `updateCareerFair`(IN pSemester varchar(25), IN pYear varchar(4),
                                                  IN UpdatedSemester varchar(25), IN UpdatedYear varchar(4))
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `updateInterviewSchedule` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `updateInterviewSchedule`(IN Company varchar(25), IN StudentEmail varchar(25),
...
-- Dump completed on 2020-04-18 20:08:38

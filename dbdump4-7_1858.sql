...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `insertStudent`(IN FirstName varchar(25), IN LastName varchar(25), IN StudentEmail varchar(25),
                                               IN AcademicYear varchar(25), IN Major varchar(25))
BEGIN
    declare spk int DEFAULT 0;
...
-- Dump completed on 2020-04-07 22:58:18
